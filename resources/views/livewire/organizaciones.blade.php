<div>
    ...
    <x-auth-header 
        :title="__('Gestión de organizaciones')" 
        :description="__('Visualiza y administra las organizaciones de la aplicación')"
    />

    <div class="mx-auto max-w-7xl">
        <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 gap-4">
            <h1 class="text-2xl font-bold text-gray-800 dark:text-white">Lista de organizaciones</h1>
            <div class="flex w-full sm:w-auto">
                <flux:input wire:model.live="buscar" icon="magnifying-glass" placeholder="Buscar organizacion">
                ...
                <flux:modal.trigger name="crearOrganizacion">
                    ...
                    variant="primary"
                    icon="plus"
                    class="w-full sm:w-auto bg-emerald-700 hover:bg-emerald-800"> Nueva organizacion 
                    </flux:button>
                </flux:modal.trigger>
        </div>
                ...
                <table class="w-full min-w-max">
                    <thead class="bg-gray-50 dark:bg-gray-700">
                        <tr>
                            ...
                            <th wire:click="ordenar('nit')" class="cursor-pointer px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-300 uppercase tracking-wider">Nit</th>
                            <th wire:click="ordenar('direccion')" class="cursor-pointer px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-300 uppercase tracking-wider">Direccion</th>
                            <th wire:click="ordenar('telefono')" class="cursor-pointer px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-300 uppercase tracking-wider">Telefono</th>
    ...
    <flux:modal name="crearOrganizacion" size="lg">
        <div class="space-y-4 p-4">
            <div>
                <flux:heading size="lg">Registrar organizacion</flux:heading>
                <flux:text class="mt-1 text-gray-600">Completa los campos para registrar una nueva organizacion.</flux:text>
            </div>
    ...
    <flux:modal name="editarOrganizacion" size="lg">
        <div class="space-y-4 p-4">
            <div>
                <flux:heading size="lg">Modificar organizacion</flux:heading>
                <flux:text class="mt-1 text-gray-600">Modifica la informacion de la organizacion.</flux:text>
            </div>
        ...
        <div class="space-y-6">
            <div>
                ...
                <flux:text class="mt-2">
                    <p>Se eliminará la organizacion <span class=" text-red-400">{{ $nombre }}</span>.</p>
                    <flux:spacer/>
